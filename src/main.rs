use osr_ai_gm::command::combat_cmds::{
    ...
    MonsterAttackCommand, MoraleCommand, NextPhaseCommand, RetreatCommand, SetHelplessCommand,
    SpawnPlacedCommand, StartCombatCommand, TurnUndeadCommand, WithdrawalCommand,
};
...
use osr_ai_gm::command::inventory_cmds::{BuyCommand, DropCommand, EquipCommand, LootCommand, ShopCommand, UnequipCommand};
...
fn build_registry() -> CommandRegistry {
    ...
    registry.register(Box::new(NextPhaseCommand));
    ...
    registry.register(Box::new(SpawnPlacedCommand));
    // Inventory
    ...
    registry.register(Box::new(UnequipCommand));
    // Dungeon Exploration
